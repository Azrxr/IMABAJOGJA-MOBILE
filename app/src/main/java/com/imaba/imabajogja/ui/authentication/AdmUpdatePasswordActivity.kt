...
import com.imaba.imabajogja.databinding.ActivityAdmUpdatePasswordBinding
import com.imaba.imabajogja.databinding.ActivityUpdatePasswordBinding
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class AdmUpdatePasswordActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAdmUpdatePasswordBinding
    private val viewModel: AuthViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAdmUpdatePasswordBinding.inflate(layoutInflater)
    ...
    private fun updatePassword() {
        binding.btnUpdate.setOnClickListener {
            ...
            viewModel.admUpdatePassword(currentPassword, newPassword, passwordConfirmation).observe(this) { result ->
                when (result) {
                    is Result.Loading -> {
